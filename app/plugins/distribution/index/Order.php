...
class Order extends Common
{
    ...
    {
        // 获取总数
        $total = BusinessService::UserOrderTotal($this->form_where);
        ...
        // 浏览器名称
        MyViewAssign('home_seo_site_title', SeoService::BrowserSeoTitle('分销订单 - 我的分销', 1));

        // 参数
        MyViewAssign('params', $params);
        return MyView('../../../plugins/distribution/view/index/order/index');
    }
    ...
    public function Detail($params = [])
    {
        ...
        return MyView('../../../plugins/distribution/view/index/order/detail');
    }
}
?>
 ...
 */
class ShopProfit extends Common
{
    /**
     * 构造方法
     * @author   Devil
    ...
    public function Index($params = [])
    {
        ...
        // 浏览器名称
        MyViewAssign('home_seo_site_title', SeoService::BrowserSeoTitle('商家佣金订单 - 我的分销', 1));

        // 参数
        MyViewAssign('params', $params);
        return MyView('../../../plugins/distribution/view/index/shopprofit/index');
    }
    ...
    public function Detail($params = [])
    {
        ...
        return MyView('../../../plugins/distribution/view/index/shopprofit/detail');
    }
}
?>
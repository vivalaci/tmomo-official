    ...
    public function Run($params = [])
    {
        ...
        return [
            ...
            'base' => [
                'key_field'     => 'id',
                'is_search'     => 1,
                'search_url'    => PluginsHomeUrl('distribution', 'promotionuser', 'index', ['type'=>$type, 'start'=>$start, 'end'=>$end]),
            ],
            // 表单配置
            'form' => [
                [
                ...
                [
                    ...
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/distribution/view/index/promotionuser/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],

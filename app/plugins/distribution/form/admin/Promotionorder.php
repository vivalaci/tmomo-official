    ...
    public function Run($params = [])
    {
        ...
        return [
            ...
            'base' => [
                'key_field'     => 'id',
                'is_search'     => 1,
                'search_url'    => PluginsAdminUrl('distribution', 'promotionorder', 'index', ['uid'=>$uid, 'type'=>$type, 'start'=>$start, 'end'=>$end]),
            ...
            'form' => [
                ...
                [
                    ...
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/distribution/view/admin/promotionorder/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],

...
CREATE TABLE IF NOT EXISTS `{PREFIX}plugins_distribution_profit_log` (
  ...
  `profit_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '收益类型（0金额, 1积分）',
  ...
  `level` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '当前级别（0向下，1一级，2二级，3三级，4内购，5自提点一级，6自提点二级，7自提点三级，8指定商品返现，9指定商品销售返佣，10指定商品阶梯返佣）',

        ...
        return [
            ...
            'form' => [
                ...
                [
                    'label'         => '图片',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/activity/view/admin/slider/module/images',
                    'grid_size'     => 'sm',
                ],
                [
                    'label'         => '事件类型',
                ...
                [
                    ...
                    'view_type'     => 'status',
                    'view_key'      => 'is_enable',
                    'post_url'      => PluginsAdminUrl('activity', 'slider', 'statusupdate'),
                    'is_form_su'    => 1,
                    'align'         => 'center',
                    'search_config' => [
                        'form_type'         => 'select',
                ...
                [
                    ...
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/activity/view/admin/slider/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],

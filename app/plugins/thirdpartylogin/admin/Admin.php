...
use app\plugins\thirdpartylogin\admin\Common;
...
class Admin extends Common
{
    ...
    public function Index($params = [])
    {
        ...
        if($ret['code'] == 0)
        {
            ...
            return MyView('../../../plugins/thirdpartylogin/view/admin/admin/index');
        } else {
            return $ret['msg'];
        }
    }
    ...
    public function SaveInfo($params = [])
    {
        ...
        {
            MyViewAssign('data', $ret['data']);
            return MyView('../../../plugins/thirdpartylogin/view/admin/admin/saveinfo');
        } else {
            return $ret['msg'];
        }
    }

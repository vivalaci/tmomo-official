...
// | Author: Devil
// +----------------------------------------------------------------------
namespace app\plugins\seckill\form\index;
...
class ShopGoods
{
    ...
    public function __construct($params = [])
    {
        ...
        if(empty($shop_id))
        {
            $this->condition_base[] = ['g.shop_id', '<', 0];
        } else {
            $this->condition_base[] = ['g.shop_id', '=', $shop_id];
        }
    }
        ...
        return [
            ...
            'form' => [
                ...
                [
                    'label'         => '商品信息',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/seckill/view/index/shopgoods/module/info',
                    'grid_size'     => 'lg',
                    'is_sort'       => 1,
                    'sort_field'    => 'title',
                    'search_config' => [
                ...
                [
                    'label'         => '秒杀价',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/seckill/view/index/shopgoods/module/seckill_price',
                    'grid_size'     => 'sm',
                ],
                [
                    'label'         => '销售价格',
                ...
                [
                    ...
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/seckill/view/index/shopgoods/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],

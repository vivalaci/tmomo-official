    ...
    public function Run($params = [])
    {
        ...
        return [
            ...
            'base' => [
                ...
                'is_search'     => 1,
                'search_url'    => PluginsAdminUrl('coupon', 'couponuser', 'index', $cid_map),
                'is_delete'     => 1,
                'delete_url'    => PluginsAdminUrl('coupon', 'couponuser', 'delete'),
                'delete_key'    => 'ids',
                'is_middle'     => 0,
            ],
            // 表单配置
            'form' => [
                ...
                [
                    ...
                    'view_type'         => 'module',
                    'view_key'          => '../../../plugins/coupon/view/admin/couponuser/module/coupon',
                ...
                [
                    ...
                    'view_type'     => 'status',
                    'view_key'      => 'is_valid',
                    'post_url'      => PluginsAdminUrl('coupon', 'couponuser', 'statusupdate'),
                    'is_form_su'    => 1,
                    'align'         => 'center',
                    'search_config' => [
                        'form_type'         => 'select',
                ...
                [
                    ...
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/coupon/view/admin/couponuser/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],

...
class Admin extends Common
{
    ...
    {
        MyViewAssign('label_style_list', BaseService::ConstData('plugins_label_style_list'));
        MyViewAssign('data', $this->plugins_config);
        return MyView('../../../plugins/label/view/admin/admin/index');
    }
    ...
    public function SaveInfo($params = [])
    {
        MyViewAssign('label_style_list', BaseService::ConstData('plugins_label_style_list'));
        MyViewAssign('data', $this->plugins_config);
        return MyView('../../../plugins/label/view/admin/admin/saveinfo');
    }

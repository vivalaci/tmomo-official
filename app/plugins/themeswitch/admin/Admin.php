...
use app\plugins\themeswitch\admin\Common;
...
class Admin extends Common
{
    ...
    {        
        ...
        if($ret['code'] == 0)
        {
            ...
            return MyView('../../../plugins/themeswitch/view/admin/admin/index');
        } else {
            return $ret['msg'];
        }
    }
    ...
    public function SaveInfo($params = [])
    {
        ...
        {
            MyViewAssign('data', $ret['data']);
            return MyView('../../../plugins/themeswitch/view/admin/admin/saveinfo');
        } else {
            return $ret['msg'];
        }
    }

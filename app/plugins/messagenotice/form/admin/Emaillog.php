        ...
        return [
            ...
            'form' => [
                ...
                [
                    ...
                    'view_type'     => 'module',
                    'grid_size'     => 'sm',
                    'view_key'      => '../../../plugins/messagenotice/view/admin/emaillog/module/content',
                ],
                [
                    'label'         => '失败原因',
                    'view_type'     => 'field',
                ...
                [
                    ...
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/messagenotice/view/admin/emaillog/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],
            // 数据配置
            'data'  => [
                'table_name'            => 'PluginsMessagenoticeEmailLog',

...
class EmailLogDataService
{
    ...
    public static function EmailLogDelete($params = [])
    {
        ...
        // 删除操作
        if(Db::name('PluginsMessagenoticeEmailLog')->where(['id'=>$params['ids']])->delete())
        {
    ...
    public static function EmailLogAllDelete($params = [])
    {
        ...
        if(Db::name('PluginsMessagenoticeEmailLog')->where($where)->delete() === false)
        {

...
class Level extends Common
{
    ...
    public function Index($params = [])
    {
        ...
        return MyView('../../../plugins/membershiplevelvip/view/admin/level/index');
    }
    ...
    public function Detail($params = [])
    {
        ...
        return MyView('../../../plugins/membershiplevelvip/view/admin/level/detail');
    }
    ...
    public function SaveInfo($params = [])
    {
        ...
        return MyView('../../../plugins/membershiplevelvip/view/admin/level/saveinfo');
    }

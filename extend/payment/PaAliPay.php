...
class PaAliPay
{
    ...
    public function Config()
    {
        // 基础信息
        $base = [
            'name'          => 'PaymentAsia支付宝',  // 插件名称
            'version'       => '1.0.0',  // 插件版本
            'apply_version' => '不限',  // 适用系统版本描述
            'apply_terminal'=> ['pc', 'h5'], // 适用终端 默认全部 ['pc', 'h5', 'ios', 'android', 'alipay', 'weixin', 'baidu', 'toutiao']
            'desc'          => 'PaymentAsia支付宝支付方式',  // 插件描述（支持html）
            'author'        => 'vijay',  // 开发者
            'author_url'    => 'tmomo.hk',  // 开发者主页
        ];
    ...
    public function Pay($params = [])
    {
        ...
        $parameter = [
            ...
            'return_url'        => APPLICATION_CLIENT_TYPE == 'h5' 
        ? 'https://tmomo.hk/payment_h5_callback.php'  // H5 回调处理
        : $params['call_back_url'],  // Web 回调处理
        ];
        ...
        $html .= "<input type='hidden' name='network' value='Alipay'>";
